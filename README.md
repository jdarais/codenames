...
[![GoDoc](https://godoc.org/github.com/jdarais/codenames?status.svg)](https://godoc.org/github.com/jdarais/codenames)
...
```
go install github.com/jdarais/codenames/cmd/codenames
```
